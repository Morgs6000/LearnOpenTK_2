...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader shader = new Shader("src/blending.vs", "src/blending.fs");
        ...
        uint transparentTexture = LoadTexture("res/textures/window.png");
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            {
                float distance = Vector3.Distance(_camera.Position, windows[i]);
            ...
            // vegetação
            GL.BindVertexArray(transparentVAO);
            GL.BindTexture(TextureTarget.Texture2D, transparentTexture);
