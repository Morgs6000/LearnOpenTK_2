...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader shader = new Shader("src/default.vs", "src/default.fs");
        Shader normalShader = new Shader("src/geometry_shader.vs", "src/geometry_shader.fs", "src/geometry_shader.gs");

        // carregar modelos
        // --------------------------------------------------
        StbImage.stbi_set_flip_vertically_on_load(1);
        Model backpack = new Model("res/objects/backpack/backpack.obj");
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            // desenha o modelo como de costume
