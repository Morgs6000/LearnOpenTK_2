...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            // vincular ao framebuffer e desenhar na textura de cor como faríamos normalmente,
            // mas com a câmera de visualização invertida. 
            ...
            _camera.Yaw -= 180.0f; // redefina-o para a sua orientação original
