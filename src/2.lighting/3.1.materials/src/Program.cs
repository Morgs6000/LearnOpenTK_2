...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader lightingShader = new Shader("src/materials.vs", "src/materials.fs");
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            lightingShader.SetVec3("material.specular", 0.5f, 0.5f, 0.5f); // a iluminação especular não tem efeito total no material deste objeto
