...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader lightingShader = new Shader("src/basic_lighting.vs", "src/basic_lighting.fs");
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            _lightPos.X = 1.0f + MathF.Sin((float)GLFW.GetTime()) * 2.0f;
            _lightPos.Y = MathF.Sin((float)GLFW.GetTime() / 2.0f) * 1.0f;
