...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        // --------------------------------------------------
        Shader lightingShader = new Shader("src/light_casters.vs", "src/light_casters.fs");
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            lightingShader.Use();
            lightingShader.SetVec3("light.position", _camera.Position);
            lightingShader.SetVec3("light.direction", _camera.Front);
            ...
            // cada ambiente e tipo de iluminação exigem alguns ajustes para obter o melhor resultado possível.
