...
public class Program
{
    ...
    private unsafe static void Main(string[] args)
    {
        ...
        while (!GLFW.WindowShouldClose(window))
        {
            ...
            tranform *= Matrix4.CreateTranslation(new Vector3(0.5f, -0.5f, 0.0f)); // inverti a ordem
            tranform *= Matrix4.CreateFromAxisAngle(new Vector3(0.0f, 0.0f, 1.0f), (float)GLFW.GetTime()); // inverti a ordem
