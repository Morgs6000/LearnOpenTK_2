...
public class Program
{
    ...
    private static Matrix4 CalculateLookAtMatrix(Vector3 position, Vector3 target, Vector3 worldUp)
    {
        // 1. Posição = conhecida
        ...
        Matrix4 translation = Matrix4.Identity; // Matriz identidade por padrão

        translation.Row3.X = -position.X; // Quarta coluna, primeira linha
        translation.Row3.Y = -position.Y;
        translation.Row3.Z = -position.Z;

        Matrix4 rotation = Matrix4.Identity;

        rotation.Row0.X = xaxis.X; // Primeira coluna, primeira linha
        rotation.Row1.X = xaxis.Y;
        rotation.Row2.X = xaxis.Z;

        rotation.Row0.Y = yaxis.X; // Primeira coluna, segunda linha
        rotation.Row1.Y = yaxis.Y;
        rotation.Row2.Y = yaxis.Z;

        rotation.Row0.Z = zaxis.X; // Primeira coluna, terceira linha
        rotation.Row1.Z = zaxis.Y;
        rotation.Row2.Z = zaxis.Z;
